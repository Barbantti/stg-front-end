...
import { employeeRegister } from "@/src/api/auth.route";
...
const EmployeeRegister = () => {
  ...
  // Função para realizar a validação dos dados e o registro do colaborador
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Realizando a validação dos campos preenchidos com o Yup
      const schema = Yup.object({
        firstName: Yup.string().required("Campo obrigatório"),
        lastName: Yup.string().required("Campo obrigatório"),
        birthDate: Yup.string().required("Campo obrigatório"),
        hireDate: Yup.string().required("Campo obrigatório"),
        wage: Yup.number().required("Campo obrigatório"),
        email: Yup.string()
      ...
      // Enviando os dados para realizar o cadastro
      const response = await employeeRegister(formDataWithoutConfirmPassword);
