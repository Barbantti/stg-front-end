...
const EmployeeReset = () => {
  ...
  // Função para capturar o email preenchido pelo colaborador
  ...
  const handleForgotSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await forgotEmployeePassword(forgotData);
  ...
  // Função para capturar a nova senha preenchida pelo colaborador
  ...
  const handleResetSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success === true) {
        ...
        router.push("/profile/employee-profile");
      } else {
        toast({
          title: "Erro",
